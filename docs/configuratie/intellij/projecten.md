...
<div align="center" style="margin-bottom: 20px;">
  <img src="../../../images/intellij/configuratie/default-project-directory.png" alt="Default project directory" style="width: 85%; max-width: 100%; border: 2px solid #ccc; border-radius: 4px;">
</div>
